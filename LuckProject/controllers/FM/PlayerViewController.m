...
-(void)createUI{
    ...
    [self.backBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(self.baseV.mas_top).offset(40);
    ...
    [self.titleLable mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(self.baseV.mas_top).offset(topHeight + 20);
    ...
    [self.headView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(self.titleLable.mas_bottom).offset(50);
        make.centerX.mas_equalTo(self.baseV.mas_centerX);
    ...
    [self.playBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.mas_equalTo(self.baseV.mas_centerX);
        make.centerY.mas_equalTo(self.baseV.mas_bottom).offset(-60);
    ...
    [self.slider addTarget:self action:@selector(playMusicValue:) forControlEvents:UIControlEventEditingChanged];
...
-(void)nextOneClick:(UIButton*)button{
    ...
    if (self.modelArr.count) {
        ...
        [self showWarningHudWithWarningTitle:@"先选择曲目吧"];
        [self dismissHudAfter:2.f];
    }
...
-(void)playMusicValue:(UISlider*)slider{
