...
@interface FMViewController ()<UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UICollectionViewDataSource>
...
-(void)createCollectionView{
    ...
    self.collectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(0, topHeight, DREAMCSCREEN_W, DREAMCSCREEN_H - topHeight - 49) collectionViewLayout:flowLayout];
